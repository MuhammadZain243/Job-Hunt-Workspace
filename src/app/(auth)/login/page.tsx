          ...
          <div className="max-w-xl space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-foreground max-w-lg text-4xl font-semibold tracking-tight sm:text-5xl">
                  Calm, private control over your job search.
                </h1>
                <p className="text-muted-foreground max-w-2xl text-base leading-7">
                  Sign in to your personal workspace for applications, research,
                  outreach drafts, and next steps. The experience stays focused
                  and owner-only.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <div className="border-border/70 bg-background/80 rounded-2xl border p-4">
                <ShieldCheck className="text-foreground mb-3 size-5" />
              ...
              <div className="border-border/70 bg-background/80 rounded-2xl border p-4">
                <Sparkles className="text-foreground mb-3 size-5" />
              ...
              <div className="border-border/70 bg-background/80 rounded-2xl border p-4">
                <CheckCircle2 className="text-foreground mb-3 size-5" />
